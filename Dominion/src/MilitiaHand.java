  ...
  implements ActionListener, MouseListener
{
  ...
  public MilitiaHand()
  {
    ...
    this.text.setText("Cards To Select:" + this.cardsSelected);
    ...
    this.text.setText("Cards Selected:" + this.cardsSelected + " out of " + (this.totalCards - 3));
    for (int counter = 0; counter < 5; counter++) {
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (source == this.left)
    {
      if ((this.displayed[0].intValue() > 0) && (this.totalCards > 5))
      {
        ...
        for (int counter = 1; counter < 6; counter++)
        {
          ...
          if (selected[this.displayed[counter].intValue()] != 0) //Doesnt like Int
        	  {
    ...
    {
      if (this.cardsSelected == this.totalCards - 3) {
        dispose();
      } else {
        JOptionPane.showMessageDialog(null, "You still need to select " + (
          this.totalCards - 3 - this.cardsSelected) + " to discard.");
      }
    }
