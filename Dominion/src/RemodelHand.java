  ...
  implements ActionListener, MouseListener
{
  ...
  public void actionPerformed(ActionEvent e)
  {
    ...
    if (source == this.left)
    {
      if ((this.displayed[0].intValue() > 0) && (this.totalCards > 5))
      {
        ...
        for (int counter = 1; counter < 6; counter++)
        {
          ...
          if (selected[this.displayed[counter].intValue()] != 0) //Doesn't like Int
          {
    ...
    {
      if ((this.cardsSelected > 1) || (this.cardsSelected < 1)) {
        JOptionPane.showMessageDialog(null, "Must pick 1 and only 1 card");
      } else {
        dispose();
      }
    }
    ...
    {
      if (selected[this.displayed[1].intValue()] != 0) //Doesn't like Int
      {
    ...
    {
      if (selected[this.displayed[2].intValue()] != 0) //Doesn't like Int
      {
    ...
    {
      if (selected[this.displayed[3].intValue()] != 0) //Doesn't like Int
      {
    ...
    {
      if (selected[this.displayed[4].intValue()] != 0) //Doesn't like Int
      {
      ...
      if (selected[this.displayed[5].intValue()] != 0) //Doesn't like Int
      {
